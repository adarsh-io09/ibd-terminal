...
def auto_seed():
    """Run seeding only if the database is empty."""
    if Deal.query.first() is None:
        ...
        # IC questions for first two deals
        for deal in deals[:2]:
            questions = [
        ...
        print("Database auto-seeded with 5 deals.")
    else:
        print("Database already contains deals, skipping seed.")